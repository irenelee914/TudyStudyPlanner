...
public struct EKProperty {
    ...
    public struct TextFieldContent {
        ...
        public init(keyboardType: UIKeyboardType = .default, placeholder: LabelContent, textStyle: LabelStyle, isSecure: Bool = false, leadingImage: UIImage? = nil, bottomBorderColor: UIColor = .clear, datePicker: Bool = false) {
